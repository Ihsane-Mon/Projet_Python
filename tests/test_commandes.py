from modules.commandes import creer_commande, charger_commandes, valider_commande, annuler_commande
...
for c in charger_commandes():
    print(f"#{c['id']} | Produit {c['produit_id']} | Qté: {c['quantite']} | Total: {c['total']}€ | Statut: {c['statut']}")
